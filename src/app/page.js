      ...
      <div className="flex flex-row p-2 h-12 justify-between mb-32">
        ...
        <div className="relative h-8 w-44 flow-hidden rounded-full">
          ...
          <input
            type="search"
            id="search"
            className="block ml-2 px-6 text-xs text-neutral-400 border-2 border-transparent rounded-full bg-transparent outline-none box-border h-full w-full flex-1 placeholder:text-neutral-600"
